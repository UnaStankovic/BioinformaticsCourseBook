...
Replikacija počinje u regionu genoma koji se naziva \textbf{početni region replikacije} (skraćeno \textit{oriC}), izvode je DNK polimeraze, koje predstavljaju mašine za kopiranje na molekularnom nivou.\\\\
...
Pitamo se kako ćelija prepoznaje \textit{oriC}? Sigurno je da postoji neka niska aminokiselina koja označava \textit{oriC}, ali kako ga prepoznati?\\
Posmatrajmo bakterijski genom, on se sastoji od jednog kružnog hromozoma. Istraživanje je pokazalo da je region, koji predstavlja \textit{oriC} kod bakterija,
...
Znamo da DNKA utiče na početak replikacije. \textit{DNKA} je protein koji se vezuje na kratki segment unutar \textit{oriC}, poznatiji kao \textbf{DNKA boks}. Ona predstavlja poruku unutar sekvence DNK koja govori proteinu DNKA da se veže baš tu. Postavlja se pitanje kao pronaći taj region bez prethodnog poznavanja izgleda DNKA kutije? \\\\
...
\centering
\includegraphics[width=1\textwidth]{poglavlja/1/slike/\textit{oriC}_TP.png}
\end{figure} 
...
\centering
\includegraphics[width=1\textwidth]{poglavlja/1/slike/Ecoli_\textit{oriC}.png}
\end{figure} 
