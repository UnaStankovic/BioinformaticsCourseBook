...
#Funkcija vraca pozicije na kojima se niska patern pojavljuje u tekstu, u "okolini" pozicije mid
...
#Trazenje pozicija na kojima se pojavljuje niska pattern, koriscenjem sufiksnog niza
